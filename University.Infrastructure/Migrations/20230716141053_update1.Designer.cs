...
namespace University.Infrastructure.Migrations
{
    ...
    [Migration("20230716141053_update1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("University.Domain.Entities.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("University.Domain.Entities.User.User", b =>
                {
                    b.HasOne("University.Domain.Entities.Lecturers.Lecturer", "Lecturer")
                        .WithOne()
                        .HasForeignKey("University.Domain.Entities.User.User", "LecturerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("University.Domain.Entities.Students.Student", "Student")
                        .WithOne()
                        .HasForeignKey("University.Domain.Entities.User.User", "StudentId")
                        .OnDelete(DeleteBehavior.Restrict);
